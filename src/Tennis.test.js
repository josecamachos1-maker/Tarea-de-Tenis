...
describe("tennis", () => {
  it("Deberia devolver Game for Player 1 despues de ventaja", () => {
    let tennis = new Tennis()
...
describe("tennis", () => {
  it("Deberia devolver Game for Player 1 desde 40-30", () => {
    let tennis = new Tennis()

    expect(tennis.score(50,30)).toEqual("Game for Player 1");
  });
});
describe("tennis", () => {
  it("Deberia devolver Game for Player 2 desde 30-40", () => {
    let tennis = new Tennis()
